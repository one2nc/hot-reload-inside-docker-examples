...
Then follow steps in [Remote Debugging Using IntelliJIDEA](https://github.com/one2nc/hot-reload-inside-docker-examples/blob/main/README.md#remote-debugging-using-intellijidea) to attach a debugger.
